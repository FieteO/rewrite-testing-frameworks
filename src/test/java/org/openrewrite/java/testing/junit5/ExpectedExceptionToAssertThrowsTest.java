...
class ExpectedExceptionToAssertThrowsTest implements RewriteTest {
    ...
    @Test
    // @Disabled
    @Issue("https://github.com/openrewrite/rewrite-testing-frameworks/issues/638")
    void thatVariablesInLambdaAreMoved() {
        //language=java
        rewriteRun(
          java(
            """
              ...
              class FailFastStrategyTest {
                  ...
                  public static class SomeClass {
                      public void notifyOnError(String msg) {
    ...
    @Test
    @Issue("https://github.com/openrewrite/rewrite-testing-frameworks/issues/638")
    void thatVariablesInLambdaAreNotMovedWhenItsNotNeeded() {
        //language=java
        rewriteRun(
          java(
            """
